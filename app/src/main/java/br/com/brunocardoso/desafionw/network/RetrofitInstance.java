...
import br.com.brunocardoso.desafionw.util.PhotoDeserializer;
    ...
    public static Retrofit getInstace(){
        if (retrofit == null){
            ...
            Gson heroeConverter = new GsonBuilder().registerTypeAdapter(Hero.class, new HeroeDesirializer())
                    .create();
            Gson photoConverter = new GsonBuilder().registerTypeAdapter(Photo.class, new PhotoDeserializer())
                    .create();

            retrofit = new Retrofit.Builder()
                    .baseUrl( BASE_URL )
                    .addConverterFactory(GsonConverterFactory.create( photoConverter ) )
                    .addConverterFactory(GsonConverterFactory.create( heroeConverter ) )
